...
export const SEO_COMPARISONS = [
  ...
  },
  {
    ...
    featureTable: [
      ...
      { feature: "Free trial",                adbrief: " 1 day", competitor: "Limited (5 ads/day)" },
  ...
  // ── GoMarble ─────────────────────────────────────────────────────────────────
  {
    slug: "adbrief-vs-gomarble",
    competitorName: "GoMarble",
    adbriefPrice: "From $19/mo",
    competitorPrice: "From $49/mo",
    headline: "AdBrief vs GoMarble — Qual IA de Performance é Melhor para Gestores de Tráfego BR/LATAM?",
    metaTitle: "AdBrief vs GoMarble — Comparação Completa 2026 | AdBrief",
    metaDescription: "AdBrief vs GoMarble: compare funcionalidades, preços e casos de uso. Qual ferramenta de IA para anúncios é certa para o seu time de performance?",
    keywords: ["adbrief vs gomarble", "gomarble alternative", "gomarble alternativa", "melhor ia para gestores de tráfego", "ai para meta ads brasil"],
    summary: "GoMarble é um AI Agent focado em diagnóstico de performance para times de paid media em inglês — conecta Meta, Google, TikTok e LinkedIn e responde perguntas como 'por que meu ROAS caiu?' em segundos. AdBrief é a alternativa focada no mercado BR/MX/India, com ferramentas de criativo embutidas (gerador de hooks, roteiro, brief), alertas no Telegram em tempo real, e conversas em português e espanhol. Se o seu negócio opera em LATAM e você precisa de copy em PT/ES além de análise de dados: AdBrief. Se você é um time global que só precisa de diagnóstico em inglês: GoMarble.",
    verdict: "AdBrief ganha para gestores de tráfego BR/MX com foco em criativo. GoMarble ganha para times em inglês que precisam de análise multi-plataforma.",
    adbriefPros: [
      "Interface e IA em português e espanhol nativos",
      "Gerador de hooks, roteiro e brief criativo integrados",
      "Alertas automáticos via Telegram em tempo real",
      "Análise de conta Meta + geração de criativos na mesma plataforma",
      "Preço acessível para mercado BR/LATAM (a partir de $19/mês)",
      "Trial de 1 dia em todos os planos",
    ],
    competitorPros: [
      "Multi-plataforma: Meta + Google + TikTok + LinkedIn",
      "MCP Server open-source gratuito para integração com Claude",
      "20+ AI agents especializados",
      "Forte em diagnóstico cross-channel",
    ],
    adbriefCons: [
      "Focado em Meta Ads (Google e TikTok em breve)",
      "Sem MCP Server público ainda",
    ],
    competitorCons: [
      "Somente em inglês — sem suporte PT/ES",
      "Sem ferramentas de criativo (hooks, roteiro, brief)",
      "Sem alertas Telegram ou notificações proativas",
      "Focado em diagnóstico, não em geração de copy",
    ],
    featureTable: [
      { feature: "IA em português/espanhol",        adbrief: "Sim",     competitor: "Não" },
      { feature: "Chat com dados do Meta Ads",       adbrief: "Sim",     competitor: "Sim" },
      { feature: "Gerador de hooks e roteiros",      adbrief: "Sim",     competitor: "Não" },
      { feature: "Alertas Telegram em tempo real",   adbrief: "Sim",     competitor: "Não" },
      { feature: "Multi-plataforma (Google/TikTok)", adbrief: "Em breve", competitor: "Sim" },
      { feature: "Análise criativa (vídeo/estático)", adbrief: "Sim",    competitor: "Sim" },
      { feature: "Trial gratuito",                   adbrief: " 1 dia",   competitor: "Sim" },
      { feature: "Preço mensal",                     adbrief: "From $19",  competitor: "From $49" },
    ],
  },

  // ── Madgicx ──────────────────────────────────────────────────────────────────
  {
    slug: "adbrief-vs-madgicx",
    competitorName: "Madgicx",
    adbriefPrice: "From $19/mo",
    competitorPrice: "From $49/mo",
    headline: "AdBrief vs Madgicx — IA Conversacional vs Automação de Meta Ads",
    metaTitle: "AdBrief vs Madgicx — Comparação Completa 2026 | AdBrief",
    metaDescription: "AdBrief vs Madgicx: qual ferramenta usar para Meta Ads? Compare análise de criativos, automação de campanhas, preços e qual é a melhor para gestores de tráfego.",
    keywords: ["adbrief vs madgicx", "madgicx alternative", "madgicx alternativa", "alternativa madgicx brasil", "melhor ferramenta meta ads"],
    summary: "Madgicx é uma plataforma de automação e otimização de Meta Ads — regras automáticas, bidding inteligente, e relatórios. AdBrief é uma IA conversacional que lê seus dados de Meta Ads e responde perguntas em tempo real: qual criativo pausar, o que está escalando, por que o CTR caiu. São ferramentas diferentes: Madgicx executa o trabalho de forma automática, AdBrief te ajuda a tomar decisões melhores antes de tocar no orçamento. Muitos gestores usam as duas.",
    verdict: "AdBrief ganha para análise e geração de criativos. Madgicx ganha para automação de regras e execução.",
    adbriefPros: [
      "IA conversacional em PT/ES — pergunta e recebe resposta imediata",
      "Geração de hooks, roteiros e briefs criativos",
      "Alertas proativos via Telegram",
      "Não requer configuração de regras — só pergunta",
      "Preço mais acessível (a partir de $19/mês)",
    ],
    competitorPros: [
      "Automação de regras de campanha",
      "Bidding inteligente e otimização automática",
      "Relatórios pré-formatados",
      "Foco total em Meta Ads",
    ],
    adbriefCons: [
      "Sem automação de regras ou bidding",
      "Não executa ações nas campanhas automaticamente",
    ],
    competitorCons: [
      "Sem IA conversacional em português",
      "Sem geração de criativos ou copy",
      "Curva de aprendizado para configurar regras",
      "Preço sobe rápido conforme gasto em anúncios",
    ],
    featureTable: [
      { feature: "IA conversacional (chat)",       adbrief: "Sim",    competitor: "Não" },
      { feature: "Interface em português",         adbrief: "Sim",    competitor: "Não" },
      { feature: "Gerador de criativos/hooks",     adbrief: "Sim",    competitor: "Não" },
      { feature: "Alertas Telegram",               adbrief: "Sim",    competitor: "Não" },
      { feature: "Automação de regras",            adbrief: "Não",    competitor: "Sim" },
      { feature: "Bidding automático",             adbrief: "Não",    competitor: "Sim" },
      { feature: "Análise de criativos",           adbrief: "Sim",    competitor: "Limitado" },
      { feature: "Preço mensal",                   adbrief: "From $19", competitor: "From $49" },
    ],
  },
  ...
  // ── Triple Whale ─────────────────────────────────────────────────────────────
  {
    slug: "adbrief-vs-triple-whale",
    competitorName: "Triple Whale",
    adbriefPrice: "From $19/mo",
    competitorPrice: "From $129/mo",
    headline: "AdBrief vs Triple Whale — Análise de Criativos vs Dashboard de Atribuição",
    metaTitle: "AdBrief vs Triple Whale — Comparação Completa 2026 | AdBrief",
    metaDescription: "AdBrief vs Triple Whale: entenda a diferença entre uma IA de criativos e um dashboard de atribuição. Qual é o certo para o seu negócio de e-commerce?",
    keywords: ["adbrief vs triple whale", "triple whale alternative", "triple whale alternativa", "melhor ferramenta atribuicao ecommerce", "triple whale brasil"],
    summary: "Triple Whale é um dashboard de atribuição e analytics para e-commerce — centraliza dados de múltiplas plataformas, mostra ROAS real, LTV e cohorts. AdBrief é uma IA conversacional que foca em performance criativa: qual anúncio está gerando resultado, o que pausar, como escrever o próximo hook. Triple Whale responde 'de onde veio a venda'. AdBrief responde 'por que esse criativo converteu e como fazer mais igual'. São complementares.",
    verdict: "AdBrief ganha para times de criativo e gestores de tráfego. Triple Whale ganha para e-commerces que precisam de atribuição multi-canal.",
    adbriefPros: [
      "IA conversacional focada em criativos e copy",
      "Pergunta em português e recebe análise em segundos",
      "Gerador de hooks, roteiro e brief integrado",
      "Preço 7x mais acessível (a partir de $19/mês)",
      "Trial de 1 dia em todos os planos",
    ],
    competitorPros: [
      "Atribuição multi-touch entre plataformas",
      "Dashboard de cohort e LTV",
      "Integração com Shopify e múltiplas plataformas",
      "Pixel próprio para rastreamento server-side",
    ],
    adbriefCons: [
      "Sem atribuição multi-plataforma ou pixel próprio",
      "Focado em Meta Ads (outras plataformas em breve)",
    ],
    competitorCons: [
      "Sem IA conversacional ou geração de criativos",
      "Preço alto para pequenos gestores (a partir de $129/mês)",
      "Focado em métricas de negócio, não em criativo",
      "Sem suporte nativo em português",
    ],
    featureTable: [
      { feature: "IA conversacional em PT",        adbrief: "Sim",     competitor: "Não" },
      { feature: "Análise de criativos",           adbrief: "Sim",     competitor: "Não" },
      { feature: "Gerador de hooks/roteiros",      adbrief: "Sim",     competitor: "Não" },
      { feature: "Atribuição multi-plataforma",    adbrief: "Não",     competitor: "Sim" },
      { feature: "Dashboard de LTV/cohort",        adbrief: "Não",     competitor: "Sim" },
      { feature: "Integração Shopify",             adbrief: "Em breve", competitor: "Sim" },
      { feature: "Trial gratuito",                 adbrief: " 1 dia",   competitor: "Não" },
      { feature: "Preço mensal",                   adbrief: "From $19",  competitor: "From $129" },
    ],
  },

  // ── Supermetrics ─────────────────────────────────────────────────────────────
  {
    slug: "adbrief-vs-supermetrics",
    competitorName: "Supermetrics",
    adbriefPrice: "From $19/mo",
    competitorPrice: "From $99/mo",
    headline: "AdBrief vs Supermetrics — IA de Performance vs Conector de Dados",
    ...
    adbriefPros: [
      ...
      "IA conversacional em português e espanhol",
      "Geração de hooks e criativos integrada",
      "Sem necessidade de planilha, fórmula ou Looker Studio",
      "Preço mais acessível (a partir de $19/mês)",
    ],
    competitorPros: [
      "Conecta com 100+ fontes de dados",
      "Flexibilidade total para montar qualquer relatório",
      "Integração com Google Sheets, BigQuery, Looker Studio",
      "Ideal para analistas e squads de data",
    ],
    adbriefCons: [
      "Sem exportação para planilhas ou BI tools",
      "Não é um conector de dados raw",
    ],
    competitorCons: [
      "Sem IA — você ainda analisa os dados manualmente",
      "Curva de aprendizado para configurar conectores",
      "Preço sobe conforme número de usuários e fontes",
      "Não gera criativos nem copy",
    ],
    featureTable: [
      { feature: "IA conversacional em PT/ES",     adbrief: "Sim",    competitor: "Não" },
      { feature: "Análise automática sem planilha", adbrief: "Sim",    competitor: "Não" },
      { feature: "Gerador de criativos",           adbrief: "Sim",    competitor: "Não" },
      { feature: "Conector Google Sheets/BI",      adbrief: "Não",    competitor: "Sim" },
      { feature: "100+ fontes de dados",           adbrief: "Não",    competitor: "Sim" },
      { feature: "Alertas proativos",              adbrief: "Sim",    competitor: "Não" },
      { feature: "Trial gratuito",                 adbrief: " 1 dia",  competitor: " 14 dias" },
      { feature: "Preço mensal",                   adbrief: "From $19", competitor: "From $99" },
    ],
  },
];
...
export const SEO_HOOKS = [
  ...
  { slug: "fear-hooks", type: "fear", label: "Fear Hooks", emoji: "", description: "Activate loss aversion. What are they risking by not watching?" },
...
export const SEO_PLATFORMS = [
  ...
  { slug: "youtube",   label: "YouTube",   emoji: "" },
];
