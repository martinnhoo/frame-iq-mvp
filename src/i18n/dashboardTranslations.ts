...
export const dashTranslations: Record<DashLang, DashT> = {
  en: {
    ...
    loop_suggestions: "Suggestions", loop_based_account: "Based on your performance data",
    ...
    pe_brand_note: "The board generator will use this logo on upcoming boards for this persona",
    pe_suggested_templates: "Recommended Templates", pe_suggested_templates_desc: "Based on this persona's profile, platforms and pain points",
    pe_brand_assets_used: "Assets used in boards", pe_use_template: "Use template",
  ...
  pt: {
    ...
    loop_suggestions: "Sugestões", loop_based_account: "Baseado nos seus dados de performance",
    ...
    pe_brand_note: "O board generator vai usar esse logo nos próximos boards desta persona",
    pe_suggested_templates: "Templates Recomendados", pe_suggested_templates_desc: "Baseado no perfil, plataformas e dores desta persona",
    pe_brand_assets_used: "Assets usados nos boards", pe_use_template: "Usar template",
  ...
  es: {
    ...
    nav_workspace: "Área de Trabajo", nav_tools: "Herramientas", nav_upgrade: "Mejorar plan",
     ...
     loop_initial_msg: "Conecta tus cuentas publicitarias y analizaré tus campañas en tiempo real — o pregúntame lo que quieras.",
     loop_thinking: "Pensando...", loop_enter_to_send: "Enter para enviar",
     loop_placeholder: "Pregunta lo que quieras sobre tus campañas...",
     loop_placeholder_persona: "Pregunta sobre",
     loop_select_persona: "Selecciona una persona primero",
     loop_select_persona_content: "Para conectar {platform}, selecciona una persona (workspace) de la barra superior.",
     loop_something_wrong: "Algo salió mal", loop_try_again: "Inténtalo de nuevo.",
     loop_disconnect: "Desconectar", loop_connected: "Conectado", loop_soon: "Próximamente",
     loop_suggestions: "Sugerencias", loop_based_account: "Basado en tus datos de rendimiento",
    ...
    pe_brand_note: "El generador usará este logo en los próximos boards de esta persona",
    pe_suggested_templates: "Templates Recomendados", pe_suggested_templates_desc: "Basado en el perfil, plataformas y puntos de dolor",
    pe_brand_assets_used: "Assets usados en boards", pe_use_template: "Usar template",
    ...
    ov_lets_ship: "tu IA está activa.", ov_complete_profile: "Completa tu perfil",
  ...
  zh: {
    ...
    nav_workspace: "工作区", nav_tools: "工具", nav_upgrade: "升级方案",
     ...
     loop_initial_msg: "连接你的广告账户，我会实时分析你的广告活动——或者直接问我任何问题。",
     loop_thinking: "思考中...", loop_enter_to_send: "按回车发送",
     loop_placeholder: "问任何关于你的广告活动的问题...",
     loop_placeholder_persona: "询问关于",
     loop_select_persona: "请先选择一个人设",
     loop_select_persona_content: "要连接 {platform}，请从顶部栏选择一个人设（工作区）。",
     loop_something_wrong: "出了点问题", loop_try_again: "再试一次。",
     loop_disconnect: "断开连接", loop_connected: "已连接", loop_soon: "即将推出",
     loop_suggestions: "建议", loop_based_account: "基于你的表现数据",
    ...
    pe_brand_note: " 面板生成器将在此角色的下一个面板中使用此Logo",
    pe_suggested_templates: "推荐模板", pe_suggested_templates_desc: "基于此角色的画像、平台和痛点",
    pe_brand_assets_used: "面板使用的素材", pe_use_template: "使用模板",
    ...
    ov_lets_ship: "您的 AI 已就绪。", ov_complete_profile: "完善您的资料",
  ...
  fr: {
    ...
    nav_workspace: "Espace de travail", nav_tools: "Outils", nav_upgrade: "Mettre à niveau",
     ...
     loop_initial_msg: "Connectez vos comptes publicitaires et j'analyserai vos campagnes en temps réel — ou posez-moi n'importe quelle question.",
     loop_thinking: "Réflexion...", loop_enter_to_send: "Entrée pour envoyer",
     loop_placeholder: "Posez n'importe quelle question sur vos campagnes...",
     loop_placeholder_persona: "Demandez à propos de",
     loop_select_persona: "Sélectionnez d'abord un persona",
     loop_select_persona_content: "Pour connecter {platform}, sélectionnez un persona (espace de travail) dans la barre supérieure.",
     loop_something_wrong: "Quelque chose a mal tourné", loop_try_again: "Réessayez.",
     loop_disconnect: "Déconnecter", loop_connected: "Connecté", loop_soon: "Bientôt",
     loop_suggestions: "Suggestions", loop_based_account: "Basé sur vos données de performance",
    ...
    pe_brand_note: "Le générateur utilisera ce logo pour les prochains boards de cette persona",
    pe_suggested_templates: "Templates Recommandés", pe_suggested_templates_desc: "Basé sur le profil, plateformes et points de douleur",
    pe_brand_assets_used: "Assets utilisés dans les boards", pe_use_template: "Utiliser le template",
    ...
    ov_lets_ship: "votre IA est active.", ov_complete_profile: "Complétez votre profil",
  ...
  de: {
    ...
    nav_workspace: "Arbeitsbereich", nav_tools: "Tools", nav_upgrade: "Plan upgraden",
     ...
     loop_initial_msg: "Verbinden Sie Ihre Werbekonten und ich analysiere Ihre Kampagnen in Echtzeit — oder fragen Sie mich einfach.",
     loop_thinking: "Denke nach...", loop_enter_to_send: "Enter zum Senden",
     loop_placeholder: "Fragen Sie alles über Ihre Kampagnen...",
     loop_placeholder_persona: "Fragen Sie über",
     loop_select_persona: "Zuerst eine Persona auswählen",
     loop_select_persona_content: "Um {platform} zu verbinden, wählen Sie eine Persona (Arbeitsbereich) in der oberen Leiste.",
     loop_something_wrong: "Etwas ist schiefgelaufen", loop_try_again: "Erneut versuchen.",
     loop_disconnect: "Trennen", loop_connected: "Verbunden", loop_soon: "Demnächst",
     loop_suggestions: "Vorschläge", loop_based_account: "Basierend auf Ihren Leistungsdaten",
     loop_daily_limit: "Tageslimit erreicht", loop_daily_limit_content: "Sie haben alle {limit} Nachrichten des {plan}-Plans heute verbraucht. Limit wird morgen zurückgesetzt. Upgraden Sie auf {upgrade} für mehr.",
    ...
    pe_brand_note: "Der Board-Generator wird dieses Logo für die nächsten Boards dieser Persona verwenden",
    pe_suggested_templates: "Empfohlene Templates", pe_suggested_templates_desc: "Basierend auf Profil, Plattformen und Schmerzpunkten",
    pe_brand_assets_used: "In Boards verwendete Assets", pe_use_template: "Template verwenden",
    ...
    ov_lets_ship: "Ihre KI ist aktiv.", ov_complete_profile: "Profil vervollständigen",
  ...
  ar: {
    ...
    nav_workspace: "مساحة العمل", nav_tools: "الأدوات", nav_upgrade: "ترقية الخطة",
     ...
     loop_initial_msg: "اربط حساباتك الإعلانية وسأحلل حملاتك في الوقت الفعلي — أو اسألني أي شيء.",
     loop_thinking: "جاري التفكير...", loop_enter_to_send: "Enter للإرسال",
     loop_placeholder: "اسأل أي شيء عن حملاتك...",
     loop_placeholder_persona: "اسأل عن",
     loop_select_persona: "اختر شخصية أولاً",
     loop_select_persona_content: "لربط {platform}، اختر شخصية (مساحة عمل) من الشريط العلوي.",
     loop_something_wrong: "حدث خطأ ما", loop_try_again: "حاول مرة أخرى.",
     loop_disconnect: "قطع الاتصال", loop_connected: "متصل", loop_soon: "قريباً",
     loop_suggestions: "اقتراحات", loop_based_account: "بناءً على بيانات أدائك",
    ...
    pe_brand_note: " سيستخدم المنشئ هذا الشعار في اللوحات القادمة لهذه الشخصية",
    pe_suggested_templates: "قوالب موصى بها", pe_suggested_templates_desc: "بناءً على الملف الشخصي والمنصات ونقاط الألم",
    pe_brand_assets_used: "الأصول المستخدمة في اللوحات", pe_use_template: "استخدم القالب",
    ...
    ov_lets_ship: "ذكاؤك الاصطناعي نشط.", ov_complete_profile: "أكمل ملفك الشخصي",
