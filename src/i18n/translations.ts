...
export const translations: Record<Language, TranslationKeys> = {
  en: {
    ...
    how_title: "From competitor ad to production board in 3 steps",
    how_step1_title: "Upload any ad",
    how_step1_desc: "Drop a competitor video, paste a URL, or upload your own. Supports TikTok, Reels, YouTube Shorts, Meta.",
    ...
    feat5_before: "Running the same UGC format 4 weeks straight and watching CTR collapse",
    feat5_after: "Intelligence feed detects creative fatigue, flags model overuse, and suggests what to rotate into",
