...
export const translations: Record<Language, TranslationKeys> = {
  en: {
    ...
    hero_title_2: "Start converting.",
    hero_subtitle: "FrameIQ analyzes competitor ads, extracts what converts, and generates production-ready briefs — so your team ships 10x more creative, 10x faster.",
  ...
  es: {
    ...
    hero_title_2: "Empieza a convertir.",
    hero_subtitle: "FrameIQ analiza anuncios de la competencia, extrae lo que convierte y genera briefs listos para producción — para que tu equipo produzca 10x más creativo, 10x más rápido.",
  ...
  fr: {
    ...
    hero_badge: "Utilisé par plus de 147 équipes de performance marketing",
    hero_title_1: "Arrêtez de deviner.",
    hero_title_2: "Commencez à convertir.",
    hero_subtitle: "FrameIQ analyse les publicités concurrentes, extrait ce qui convertit et génère des briefs prêts à produire — pour que votre équipe produise 10x plus de créatifs, 10x plus vite.",
  ...
  de: {
    ...
    hero_title_1: "Schluss mit Raten.",
    hero_title_2: "Anfangen zu konvertieren.",
    hero_subtitle: "FrameIQ analysiert Wettbewerber-Anzeigen, extrahiert was konvertiert und erstellt produktionsreife Briefs — damit Ihr Team 10x mehr Creatives 10x schneller liefert.",
  ...
  ar: {
    ...
    hero_title_1: "توقف عن التخمين.",
    hero_title_2: "ابدأ بالتحويل.",
    hero_subtitle: "FrameIQ يحلل إعلانات المنافسين، يستخرج ما يحول، وينشئ ملخصات جاهزة للإنتاج — ليقوم فريقك بإنتاج 10 أضعاف المحتوى الإبداعي، أسرع بـ 10 مرات.",
  ...
  zh: {
    ...
    hero_title_1: "停止猜测。",
    hero_title_2: "开始转化。",
    hero_subtitle: "FrameIQ分析竞争对手广告，提取转化要素，生成可投产的创意简报——让您的团队以10倍速度产出10倍创意。",
