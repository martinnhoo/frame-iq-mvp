...
### 6.1 Your Content
You retain all rights to content you upload and content generated by AdBrief based on your inputs. We do not claim ownership of your analyses, boards, or generated videos. We do not claim ownership of your analyses, boards, or generated videos.

### 6.2 Our Platform
AdBrief's platform, AI models, algorithms, and interface are our proprietary property. These Terms do not grant you any rights to our intellectual property beyond the limited license to use the service. are our proprietary property. These Terms do not grant you any rights to our intellectual property beyond the limited license to use the service.
...
Content generated by AdBrief's AI (boards, scripts, videos) is provided "as-is." You are responsible for: is provided "as-is." You are responsible for:
...
TO THE MAXIMUM EXTENT PERMITTED BY LAW, ADBRIEF SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING LOSS OF PROFITS, DATA, OR BUSINESS OPPORTUNITIES. FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING LOSS OF PROFITS, DATA, OR BUSINESS OPPORTUNITIES.
