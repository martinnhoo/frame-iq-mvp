...
const T: Record<Lang, Record<string, any>> = {
  en: {
    ...
    plan_maker_f2: "Creative tools",
    plan_maker_f3: "Basic decision support",
    ...
    plan_pro_f2: "Full decision engine",
    ...
    plan_studio_f2: "Faster analysis",
    plan_studio_f3: "Agency client workspace",
    plan_studio_f4: "Priority processing",
  ...
  pt: {
    ...
    plan_maker_f2: "Ferramentas de criação",
    plan_maker_f3: "Suporte a decisões básico",
    ...
    plan_pro_f2: "Decision engine completo",
    plan_pro_f3: "Monitoramento em tempo real",
    plan_pro_f4: "Suporte multi-mercado",

    plan_studio_name: "Studio",
    plan_studio_price: "$149",
    plan_studio_period: "/mês",
    plan_studio_f1: "Contas ilimitadas",
    plan_studio_f2: "Análise acelerada",
    plan_studio_f3: "Workspace de agência",
    plan_studio_f4: "Processamento prioritário",
  ...
  es: {
    ...
    plan_maker_f2: "Herramientas de creación",
    plan_maker_f3: "Soporte a decisiones básico",
    ...
    plan_pro_f2: "Decision engine completo",
    plan_pro_f3: "Monitoreo en tiempo real",
    ...
    plan_studio_f2: "Análisis acelerado",
    plan_studio_f3: "Workspace de agencia",
    plan_studio_f4: "Procesamiento prioritario",
