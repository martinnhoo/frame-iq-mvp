...
const T: Record<Lang, Record<string, any>> = {
  en: {
    ...
    plan_maker_f1: "1 ad account",
    plan_maker_f2: "~33 improvements/mo",
    plan_maker_f3: "All AI tools",
    ...
    plan_pro_f2: "~166 improvements/mo",
    plan_pro_f3: "All AI tools",
    plan_pro_f4: "50% off per action",

    plan_studio_name: "Studio",
    plan_studio_price: "$299",
    plan_studio_period: "/mo",
    plan_studio_f1: "Unlimited accounts",
    plan_studio_f2: "Unlimited improvements",
    plan_studio_f3: "Unlimited credits",
    plan_studio_f4: "Priority support",
  ...
  pt: {
    ...
    plan_maker_f1: "1 conta de anúncios",
    plan_maker_f2: "~33 melhorias/mês",
    plan_maker_f3: "Todas as ferramentas IA",
    ...
    plan_pro_f2: "~166 melhorias/mês",
    plan_pro_f3: "Todas as ferramentas IA",
    plan_pro_f4: "50% off por ação",

    plan_studio_name: "Studio",
    plan_studio_price: "$299",
    plan_studio_period: "/mês",
    plan_studio_f1: "Contas ilimitadas",
    plan_studio_f2: "Melhorias ilimitadas",
    plan_studio_f3: "Créditos ilimitados",
    plan_studio_f4: "Suporte prioritário",
  ...
  es: {
    ...
    plan_maker_f1: "1 cuenta de anuncios",
    plan_maker_f2: "~33 mejoras/mes",
    plan_maker_f3: "Todas las herramientas IA",
    ...
    plan_pro_f2: "~166 mejoras/mes",
    plan_pro_f3: "Todas las herramientas IA",
    plan_pro_f4: "50% off por acción",

    plan_studio_name: "Studio",
    plan_studio_price: "$299",
    plan_studio_period: "/mes",
    plan_studio_f1: "Cuentas ilimitadas",
    plan_studio_f2: "Mejoras ilimitadas",
    plan_studio_f3: "Créditos ilimitados",
    plan_studio_f4: "Soporte prioritario",
