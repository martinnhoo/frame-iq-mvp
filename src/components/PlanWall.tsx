...
const T: Record<Lang, Record<string, any>> = {
  en: {
    ...
    plan_maker_f1: "1,000 credits/mo",
    plan_maker_f2: "1 ad account",
    plan_maker_f3: "All tools",

    plan_pro_name: "Pro",
    plan_pro_price: "$49",
    plan_pro_period: "/mo",
    plan_pro_badge: "Most popular",
    plan_pro_f1: "2,500 credits/mo",
    plan_pro_f2: "3 ad accounts",
    plan_pro_f3: "Multi-market support",
    plan_pro_f4: "All tools",

    plan_studio_name: "Studio",
    plan_studio_price: "$149",
    plan_studio_period: "/mo",
    plan_studio_f1: "9,000 credits/mo",
    plan_studio_f2: "Unlimited accounts",
  ...
  pt: {
    ...
    plan_maker_f1: "1.000 créditos/mês",
    plan_maker_f2: "1 conta de anúncios",
    plan_maker_f3: "Todas as ferramentas",

    plan_pro_name: "Pro",
    plan_pro_price: "$49",
    plan_pro_period: "/mês",
    plan_pro_badge: "Mais popular",
    plan_pro_f1: "2.500 créditos/mês",
    plan_pro_f2: "3 contas de anúncios",
    plan_pro_f3: "Suporte multi-mercado",
    plan_pro_f4: "Todas as ferramentas",

    plan_studio_name: "Studio",
    plan_studio_price: "$149",
    plan_studio_period: "/mês",
    plan_studio_f1: "9.000 créditos/mês",
    plan_studio_f2: "Contas ilimitadas",
  ...
  es: {
    ...
    plan_maker_f1: "1.000 créditos/mes",
    plan_maker_f2: "1 cuenta de anuncios",
    plan_maker_f3: "Todas las herramientas",

    plan_pro_name: "Pro",
    plan_pro_price: "$49",
    plan_pro_period: "/mes",
    plan_pro_badge: "Más popular",
    plan_pro_f1: "2.500 créditos/mes",
    plan_pro_f2: "3 cuentas de anuncios",
    plan_pro_f3: "Soporte multi-mercado",
    plan_pro_f4: "Todas las herramientas",

    plan_studio_name: "Studio",
    plan_studio_price: "$149",
    plan_studio_period: "/mes",
    plan_studio_f1: "9.000 créditos/mes",
    plan_studio_f2: "Cuentas ilimitadas",
