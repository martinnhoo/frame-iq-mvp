      ...
      >
        ...
        {"badge" in item && item.badge && (
          <span className="text-[9px] font-bold px-1.5 py-0.5 rounded-full"
            style={{
              ...mono,
              color: item.badge === "CORE" ? "#000" : item.badge === "AI" ? item.accent : item.accent,
              background: item.badge === "CORE" ? "linear-gradient(135deg, #a78bfa, #f472b6)" : `${item.accent}18`,
              border: item.badge === "CORE" ? "none" : `1px solid ${item.accent}30`,
            }}>
            {item.badge}
          </span>
        )}
        ...
        <nav className="flex-1 overflow-y-auto px-3 py-3 space-y-5">
          ...
          <div className="space-y-0.5">
            <p className="text-[9px] font-bold uppercase tracking-[0.2em] px-3 mb-2"
              style={{ ...syne, color: "rgba(255,255,255,0.12)" }}>Intelligence</p>
          ...
          <div className="space-y-0.5">
            <p className="text-[9px] font-bold uppercase tracking-[0.2em] px-3 mb-2"
              style={{ ...syne, color: "rgba(255,255,255,0.12)" }}>Creative Tools</p>
          ...
          <div className="space-y-0.5">
            <p className="text-[9px] font-bold uppercase tracking-[0.2em] px-3 mb-2"
              style={{ ...syne, color: "rgba(255,255,255,0.12)" }}>Audience</p>
