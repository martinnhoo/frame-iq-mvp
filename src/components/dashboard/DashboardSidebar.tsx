      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto px-4 py-4 space-y-5">
          <div className="space-y-0.5">
            <p className="text-[9px] font-bold uppercase tracking-[0.18em] text-white/12 px-3 mb-2.5" style={{ fontFamily: "'Syne', sans-serif" }}>
              Workspace
            </p>
        ...
        <div className="p-4 border-t border-white/[0.05] space-y-2">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[13px] font-semibold text-white/75 truncate group-hover:text-white transition-colors leading-tight" style={{ fontFamily: "'Syne', sans-serif" }}>
