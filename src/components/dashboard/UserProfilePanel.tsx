        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "20px 20px 32px" }}>
          ...
          {tab === "plan" && (() => {
            ...
            const FEATURES: Record<string, { icon: string; label: string }[]> = {
              free:   [{ icon:"", label: language==="pt"?"15 créditos/mês":"15 credits/month" }, { icon:"", label: language==="pt"?"Todas as tools (com limites)":"All tools (limited usage)" }, { icon:"", label: language==="pt"?"Faça upgrade para conectar contas":"Upgrade to connect ad accounts" }],
              maker:  [{ icon:"", label: language==="pt"?"1.000 créditos/mês":"1,000 credits/month" }, { icon:"", label: language==="pt"?"1 conta de anúncios":"1 ad account" }, { icon:"", label: language==="pt"?"Todas as ferramentas":"All tools" }],
              pro:    [{ icon:"", label: language==="pt"?"2.500 créditos/mês":"2,500 credits/month" }, { icon:"", label: language==="pt"?"3 contas de anúncios":"3 ad accounts" }, { icon:"", label: language==="pt"?"Todas as ferramentas":"All tools" }, { icon:"", label: language==="pt"?"Multi-mercado":"Multi-market" }, { icon:"", label: language==="pt"?"Dashboards avançados":"Advanced dashboards" }],
              studio: [{ icon:"∞", label: language==="pt"?"Créditos ilimitados":"Unlimited credits" }, { icon:"", label: language==="pt"?"Contas ilimitadas":"Unlimited accounts" }, { icon:"", label: language==="pt"?"Todas as ferramentas":"All tools" }, { icon:"", label: language==="pt"?"Workspace agência":"Agency workspace" }, { icon:"", label: language==="pt"?"Prioridade máxima":"Maximum priority" }],
            };
