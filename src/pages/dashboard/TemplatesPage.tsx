      ...
      <div className="relative w-full sm:max-w-lg rounded-t-3xl sm:rounded-3xl border border-white/[0.1] bg-[#0a0a0a] shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto">
        ...
        <div className="page-enter p-6 space-y-5">
          ...
          <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 gap-3">
            <div>
              <p className="text-[10px] uppercase tracking-widest text-white/45 mb-2" style={{ fontFamily: "'Inter', 'Inter', system-ui, sans-serif" }}>Target market</p>
            ...
            <div>
              <p className="text-[10px] uppercase tracking-widest text-white/45 mb-2" style={{ fontFamily: "'Inter', 'Inter', system-ui, sans-serif" }}>Ad language (VO)</p>
              <div className="relative">
          ...
          {preview ? (
            <div className="space-y-3">
              <div className="rounded-2xl border border-white/[0.13] bg-white/[0.06] p-4">
                <p className="text-[10px] uppercase tracking-widest text-white/45 mb-2" style={{ fontFamily: "'Inter', 'Inter', system-ui, sans-serif" }}>Translated brief</p>
              ...
              {preview.notes && (
                <div className="rounded-xl bg-emerald-500/[0.05] border border-emerald-500/15 px-4 py-3">
                  <p className="text-[10px] uppercase tracking-widest text-emerald-400/50 mb-1" style={{ fontFamily: "'Inter', 'Inter', system-ui, sans-serif" }}>Cultural adaptation</p>
