...
const UI: Record<string, Record<string, string>> = {
  ...
  es: { title: "Análisis", new_btn: "Nuevo análisis", search_ph: "Buscar por nombre...", recent: "Recientes", top_score: "Mejor score", empty_title: "Sin análisis aún", empty_sub: "Sube un video para obtener scores de hook y perspectivas creativas", empty_btn: "Crear primer análisis", untitled: "Análisis sin título", no_match: "Sin resultados", cancel: "Cancelar análisis", delete: "Eliminar análisis" },
  en: { title: "Analyses", new_btn: "New Analysis", search_ph: "Search by name...", recent: "Recent", top_score: "Top Score", empty_title: "No analyses yet", empty_sub: "Upload a video to get AI-powered hook scores and creative insights", empty_btn: "Create first analysis", untitled: "Untitled Analysis", no_match: "No analyses match", cancel: "Cancel analysis", delete: "Delete analysis" },
};
