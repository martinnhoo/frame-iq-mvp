...
const T = {
  pt: {
    ...
    metrics: { spend: "Investido", impressions: "Impressões", clicks: "Cliques", cpc: "CPC", conversions: "Conversões", frequency: "Frequência", days: "Dias", ctr: "CTR", roas: "ROAS" },
    date_locale: "pt-BR",
  ...
  es: {
    ...
    metrics: { spend: "Invertido", impressions: "Impresiones", clicks: "Clics", cpc: "CPC", conversions: "Conversiones", frequency: "Frecuencia", days: "Días", ctr: "CTR", roas: "ROAS" },
    date_locale: "es-MX",
