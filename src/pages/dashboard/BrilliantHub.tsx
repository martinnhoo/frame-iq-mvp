...
const MAIN_TOOLS: Tool[] = [
  ...
  },
  {
    ...
    icon: Video,
    color: "#22c55e",
    route: "/dashboard/hub/transcript",
    status: "soon",
    cta: "Transcrever",
  },
  {
...
const SUPPORT_TOOLS: Tool[] = [
  {
    ...
    icon: Type,
    color: "#8b5cf6",
    route: "/dashboard/hub/copywriter",
    status: "soon",
    cta: "Em breve",
  },
  {
