...
export default function LoopImportPage() {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-3xl mx-auto space-y-6">
      <button onClick={() => navigate("/dashboard/loop")} className="flex items-center gap-2 text-xs text-muted-foreground hover:text-foreground transition-colors" style={m}>
