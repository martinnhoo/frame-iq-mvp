        ...
        <div className="rounded-2xl border border-white/[0.08] bg-white/[0.02] p-8 space-y-6">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-white" style={syne}>
              {step === "done" ? "Analysis complete!" : step === "error" ? "Analysis failed" : "Analyzing your video..."}
            </h3>
            {isProcessing && <p className="text-sm text-white/30 mt-1">Usually takes 30–60 seconds</p>}
          </div>
            ...
            {STEP_ORDER.slice(0, -1).map((s, i) => {
              ...
              return (
                <div key={s} className={`flex items-center gap-3 transition-all duration-300 ${
                  done || active ? "text-white" : "text-white/20"
                }`}>
                  {done ? (
          ...
          <div className="h-2 rounded-full overflow-hidden" style={{ background: "rgba(255,255,255,0.06)" }}>
            <div
              ...
              style={{
                ...
                background: step === "error" ? "#f87171" : step === "done" ? "#34d399" : "linear-gradient(90deg, #a78bfa, #f472b6)",
              }}
            />
          </div>
