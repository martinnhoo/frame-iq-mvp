...
const t = {
  ...
  pt: {
    ...
    subtitle: "Compartilhe o AdBrief com um amigo — ambos ganham +10 análises bônus",
    yourCode: "Seu código de indicação",
    copyLink: "Copiar link",
    copied: "Copiado!",
    stats: "Suas estatísticas",
    referrals: "Indicações",
    bonusEarned: "Análises bônus ganhas",
    ...
    shareText: "Experimente o AdBrief — inteligência de Meta Ads com IA. Use meu código para +10 análises grátis:",
    howItWorks: "Como funciona",
    step1: "Compartilhe seu link de indicação com amigos ou colegas",
    step2: "Quando eles se cadastram e usam seu código, ambos ganham +10 análises bônus",
