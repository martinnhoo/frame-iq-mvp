  ...
  return (
    <SeoLayout title="AdBrief vs AdSpy, BigSpy, Minea & More — AdBrief" description="Honest, feature-by-feature comparisons of AdBrief against other ad intelligence tools." canonical="/compare">
      <div style={{ maxWidth: 860, margin: "0 auto", padding: "64px 24px 0" }}>
        ...
        <SeoCTA context="compare" headline="See AdBrief in action" sub="3-day free trial. Card required, no charge for 24h." primaryLabel="Try for free" />
      </div>
    </SeoLayout>
  );
}
  ...
  if (!comp) return (
    <SeoLayout title="Comparison Not Found — AdBrief" description="" noIndex>
      <div style={{ textAlign: "center", padding: "120px 24px" }}>
        ...
        <button onClick={() => navigate("/compare")} style={{ color: "#0ea5e9", background: "none", border: "none", cursor: "pointer", marginTop: 12 }}>← All comparisons</button>
      </div>
    </SeoLayout>
  );
