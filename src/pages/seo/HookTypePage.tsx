...
import { SEO_HOOK_TYPE_PAGES } from "@/data/seoData";
import { findHookTypeBySlug } from "@/data/seoData";
import SeoLandingPage from "./SeoLandingPage";

export default function HookTypePage() {
  const { slug } = useParams<{ slug: string }>();
  const navigate = useNavigate();
  const page = findHookTypeBySlug(slug!);
  ...
  return (
    <SeoLandingPage
      ...
      canonical={"/hooks/" + slug}
      badge={(page as any)["hookType"] || undefined}
