    ...
    <div style={{ minHeight: "100vh", background: "#080810", color: "rgba(255,255,255,0.85)" }}>
      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "64px 24px 80px" }}>
        ...
        <div style={{ display: "flex", gap: 12, marginBottom: 48 }}>
          <button onClick={() => navigate("/signup")} style={{ ...j, padding: "13px 28px", borderRadius: 999, fontSize: 14, fontWeight: 700, background: `linear-gradient(135deg,${accentColor},#06b6d4)`, color: "#000", border: "none", cursor: "pointer" }}>Try free — no credit card</button>
