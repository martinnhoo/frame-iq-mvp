    ...
    <SeoLayout title="Ad Creative Library — AdBrief" description="Browse top-performing ad creatives analyzed by AI. Hook scores, creative breakdowns, and frameworks for every ad." canonical="/ads-library">
      <div style={{ maxWidth: 1000, margin: "0 auto", padding: "64px 24px 0" }}>
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          <p style={{ ...m, fontSize: 12, letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(255,255,255,0.25)", marginBottom: 14 }}>Ads Library</p>
        ...
        <div style={{ marginBottom: 56 }}>
          <p style={{ ...m, fontSize: 12, letterSpacing: "0.15em", textTransform: "uppercase", color: "rgba(255,255,255,0.25)", marginBottom: 20 }}>Browse by category</p>
        ...
        <div style={{ marginBottom: 40 }}>
          <p style={{ ...m, fontSize: 12, letterSpacing: "0.15em", textTransform: "uppercase", color: "rgba(255,255,255,0.25)", marginBottom: 16 }}>By platform</p>
        ...
        {/* Browse by industry */}
        <div style={{ marginBottom: 56 }}>
          <p style={{ ...m, fontSize: 12, letterSpacing: "0.15em", textTransform: "uppercase", color: "rgba(255,255,255,0.25)", marginBottom: 16 }}>By industry</p>
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
      ...
      <div style={{ maxWidth: 1000, margin: "0 auto", padding: "64px 24px 0" }}>
        ...
        {related.length > 0 && (
          <div style={{ marginTop: 56, marginBottom: 32 }}>
            <p style={{ ...m, fontSize: 12, letterSpacing: "0.15em", textTransform: "uppercase", color: "rgba(255,255,255,0.25)", marginBottom: 16 }}>Related libraries</p>
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
              {related.map(r => r && (
          ...
          <div key={ad.id}
            ...
            <div style={{ height: 140, background: `linear-gradient(135deg, rgba(14,165,233,0.08), rgba(6,182,212,0.05))`, display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
              ...
              <div style={{ position: "absolute", top: 10, left: 10, padding: "4px 10px", borderRadius: 20, background: "rgba(0,0,0,0.7)", backdropFilter: "blur(8px)", display: "flex", alignItems: "center", gap: 6 }}>
                ...
                <span style={{ fontSize: 12, color: "rgba(255,255,255,0.3)" }}>hook</span>
              </div>
              {/* Lock overlay */}
            ...
            <div style={{ padding: "14px 16px" }}>
              <div style={{ display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 8 }}>
                <span style={{ fontFamily: "'DM Mono',monospace", fontSize: 12, padding: "3px 8px", borderRadius: 10, background: "rgba(14,165,233,0.1)", color: "#0ea5e9" }}>{ad.hookType}</span>
                <span style={{ fontFamily: "'DM Mono',monospace", fontSize: 12, padding: "3px 8px", borderRadius: 10, background: "rgba(255,255,255,0.05)", color: "rgba(255,255,255,0.35)" }}>{ad.creativeType}</span>
              </div>
              <p style={{ fontFamily: "'DM Mono',monospace", fontSize: 12, color: "rgba(255,255,255,0.2)" }}>{ad.duration}s · {ad.platform}</p>
            </div>
          </div>
        ))}
      </div>
