...
const T: Record<Lang, Record<string, string>> = {
  en: {
    ...
    hero_fine: "1-day free trial · Card required · Cancel anytime", hero_built: "BUILT ON",
    ...
    pricing_card: "Card required · No charge for 24h · Cancel anytime", pricing_cta: "Start free trial", pricing_note: "1-day trial · Cancel anytime",
  ...
  pt: {
    ...
    hero_fine: "1 dia grátis · Cartão necessário · Cancele quando quiser", hero_built: "DESENVOLVIDO COM",
    ...
    pricing_card: "Cartão obrigatório · Sem cobrança por 24h · Cancele quando quiser", pricing_cta: "Começar teste grátis", pricing_note: "1 dia de teste · Cancele quando quiser",
  ...
  es: {
    ...
    hero_fine: "1 día gratis · Tarjeta requerida · Cancela cuando quieras", hero_built: "DESARROLLADO CON",
    ...
    pricing_card: "Tarjeta requerida · Sin cobro por 24h · Cancela cuando quieras", pricing_cta: "Empezar prueba gratis", pricing_note: "1 día de prueba · Cancela cuando quieras",
