...
const T: Record<Lang, Record<string, string>> = {
  en: {
    ...
    hero_fine: "Free trial · No credit card required · Cancel anytime", hero_built: "BUILT ON",
    ...
    pricing_card: "No credit card required · Cancel anytime", pricing_cta: "Start free trial", pricing_note: "1-day trial · Cancel anytime",
  ...
  pt: {
    ...
    hero_fine: "Teste grátis · Sem cartão necessário · Cancele quando quiser", hero_built: "DESENVOLVIDO COM",
    ...
    pricing_card: "Sem cartão necessário · Cancele quando quiser", pricing_cta: "Começar teste grátis", pricing_note: "1 dia de teste · Cancele quando quiser",
  ...
  es: {
    ...
    hero_fine: "Prueba gratis · Sin tarjeta de crédito · Cancela cuando quieras", hero_built: "DESARROLLADO CON",
    ...
    pricing_card: "Sin tarjeta de crédito · Cancela cuando quieras", pricing_cta: "Empezar prueba gratis", pricing_note: "1 día de prueba · Cancela cuando quieras",
