...
function HeroLeft({ lang, onCTA, ctaLoading }: { lang: Lang; onCTA: () => void; ctaLoading?: boolean }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column' as const, justifyContent: 'center', minWidth: 0, width: '100%', position: 'relative' as const }}>
      ...
      <h1 style={{
        fontFamily: "'Inter', system-ui, sans-serif", fontWeight: 800, letterSpacing: '-0.04em', lineHeight: 1.05,
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '8px 18px', borderRadius: 10, background: 'rgba(0,130,251,0.08)', border: '1px solid rgba(0,130,251,0.22)', boxShadow: '0 0 20px rgba(0,130,251,0.07)' }}>
          ...
          <span style={{ fontFamily: "'Inter', system-ui, sans-serif", fontSize: 14, fontWeight: 700, color: '#fff', letterSpacing: '-0.02em' }}>Meta Ads</span>
        </div>
      </div>
    </div>
  );
    ...
    <section style={{
      ...
      <div style={{ maxWidth: 960, margin: "0 auto", position: "relative" }}>
        ...
        <div className="scroll-reveal" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 12, marginBottom: 20 }}>
          ...
          <p style={{ fontFamily: "'Inter', system-ui, sans-serif", fontSize: 12, fontWeight: 700, letterSpacing: "0.14em", color: "rgba(255,255,255,0.3)", textTransform: "uppercase" as const, margin: 0 }}>
            {c.label}
          </p>
        ...
        {/* Title */}
        <h2 className="scroll-reveal scroll-reveal-delay-1" style={{ fontFamily: "'Inter', system-ui, sans-serif", fontSize: "clamp(24px,3.5vw,42px)", fontWeight: 900, letterSpacing: "-0.04em", lineHeight: 1.1, textAlign: "center", color: "#fff", whiteSpace: "pre-line" as const, marginBottom: 48 }}>
          {c.title}
        </h2>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr auto 1fr", gap: "clamp(16px,2.5vw,40px)", alignItems: "center" }} className="pain-grid scroll-reveal scroll-reveal-delay-2">
          ...
          <div className="pain-col-left" style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            {c.pains.map((p, i) => (
              <div key={i} style={{
                ...
                <p style={{ fontFamily: "'Inter', system-ui, sans-serif", fontSize: 14, color: "rgba(255,255,255,0.45)", margin: 0, lineHeight: 1.55 }}>{p.text}</p>
              </div>
            ))}
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 0 }}>
            ...
            <div style={{
              ...
              <span style={{ fontFamily: "'Inter', system-ui, sans-serif", fontSize: 12, fontWeight: 800, color: "#38bdf8", letterSpacing: "0.04em" }}>{c.divider}</span>
            </div>
          ...
          <div className="pain-col-right" style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            {c.solutions.map((s, i) => (
              <div key={i} style={{
                ...
                <p style={{ fontFamily: "'Inter', system-ui, sans-serif", fontSize: 14, color: "rgba(255,255,255,0.82)", margin: 0, lineHeight: 1.55 }}>{s.text}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div className="footer-inner" style={{ display: "flex", justifyContent: "space-between", gap: 40, flexWrap: "wrap" as const, marginBottom: 40 }}>
          ...
          <div className="footer-links" style={{ display: "flex", gap: 48, flexWrap: "wrap" as const }}>
            <div>
              <p style={{ fontFamily: "'Inter', system-ui, sans-serif", fontSize: 12, fontWeight: 700, color: "rgba(255,255,255,0.2)", letterSpacing: "0.1em", textTransform: "uppercase" as const, marginBottom: 12 }}>{t.footer_product}</p>
            ...
            <div>
              <p style={{ fontFamily: "'Inter', system-ui, sans-serif", fontSize: 12, fontWeight: 700, color: "rgba(255,255,255,0.2)", letterSpacing: "0.1em", textTransform: "uppercase" as const, marginBottom: 12 }}>{t.footer_legal}</p>
