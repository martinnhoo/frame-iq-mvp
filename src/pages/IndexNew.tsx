  ...
  return (
    <section className="hero-section" style={{ padding: "clamp(56px,8vw,90px) clamp(16px,4vw,32px) clamp(48px,6vw,72px)", textAlign: "center", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: 760, margin: "0 auto", position: "relative" }}>
        <motion.div {...fade(0)} style={{ marginBottom: 28 }}><span style={{ ...j, fontSize: 11, letterSpacing: "0.16em", textTransform: "uppercase", color: "rgba(14,165,233,0.9)", fontWeight: 700 }}>{t.hero_badge}</span></motion.div> {...fade(0)} style={{ marginBottom: 28 }}><span style={{ ...j, fontSize: 11, letterSpacing: "0.16em", textTransform: "uppercase", color: "rgba(14,165,233,0.9)", fontWeight: 700 }}>{t.hero_badge}</span></motion.div> }}>{t.hero_badge}</span></motion.div>
