...
import { Upload, Loader2, Lock, ArrowRight, Check, Star, X } from "lucide-react";
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          <div style={{
            ...
            <div style={{ width: 6, height: 6, borderRadius: "50%", background: "#34d399", flexShrink: 0, boxShadow: "0 0 8px rgba(52,211,153,0.5)" }} />
            <span style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 11, fontWeight: 600, color: "rgba(52,211,153,0.85)", letterSpacing: "0.04em" }}>
