...
const Pricing = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        { text: "10 video analyses", included: true },
        { text: "10 board generations", included: true },
        { text: "50 translations", included: true },
        { text: "10 pre-flight checks", included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { text: "Unlimited hooks", included: true },
