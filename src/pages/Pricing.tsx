...
const T: Record<Lang, Record<string, any>> = {
  pt: {
    ...
    s3_free: { name: "Free", desc: "Entrada", price: "$0", credits: "15 créditos", improvements: "~15 melhorias", accounts: "1 conta", context: "Para explorar o sistema antes de usar de verdade." },
  ...
  en: {
    ...
    s3_free: { name: "Free", desc: "Entry", price: "$0", credits: "15 credits", improvements: "~15 improvements", accounts: "1 account", context: "To explore the system before committing." },
  ...
  es: {
    ...
    s3_free: { name: "Free", desc: "Entrada", price: "$0", credits: "15 créditos", improvements: "~15 mejoras", accounts: "1 cuenta", context: "Para explorar el sistema antes de comprometerse." },
