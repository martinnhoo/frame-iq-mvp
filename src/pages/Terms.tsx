  ...
  <div className="min-h-screen bg-background text-foreground">
    ...
    <main className="container mx-auto max-w-3xl px-6 py-16 space-y-8">
      ...
      <section className="space-y-4 text-sm text-muted-foreground leading-relaxed">
        ...
        <p>AdBrief is an AI-powered creative intelligence platform that provides video ad analysis, storyboard generation, script translation, hook generation, pre-flight checks, and related creative tools for performance marketing professionals.</p>
        ...
        <p>AdBrief offers Free, Creator ($9/mo), Studio ($49/mo), and Scale ($499/mo) plans. Paid plans are billed monthly. You authorize us to charge the payment method on file. Prices are in USD and may be subject to applicable taxes.</p>
        ...
        <p>Studio plans may include a 14-day free trial. If you do not cancel before the trial ends, you will be charged the applicable subscription fee.</p>
        ...
        <h2 className="text-lg font-semibold text-foreground">10. Content You Upload</h2>
        ...
        <h2 className="text-lg font-semibold text-foreground">11. Privacy</h2>
        ...
        <h2 className="text-lg font-semibold text-foreground">13. Disclaimer of Warranties</h2>
